...
// 				$output = "\n" . $output . "\n\n";
			...
			case "p":
				$output = static::processWhitespaceNewlines($output);
				$output = "\n".self::getNodeString($node, $name, $output);
				break;
				
			case "s":
				$output = self::getNodeString($node, $name, $output);
				break;
			...
			case "break":
				$output = self::getNodeString($node, $name, $output, true);
				break;
	...
	static function getNodeString($node, $name, $output, $containingTag = false){
		$tmp = $output;
		if(!$containingTag){
			$output = "<".$name."";
